...
class AnalystGraph:
    ...
    async def run(
        ...
        """
        Main entry point to run the graph (non-streaming).
        
        Args:
            query: The user's query
            session_id: The session ID
            messages: The conversation messages (effective chat history)
        ...
        """
        logger.info(
            f"🚀 Starting AnalystGraph execution",
            extra={
